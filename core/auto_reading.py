...
PAIR_SAFETY_BOUNDS = {
    "XAUUSD":   {"min_gap": 0.05, "max_gap": 0.80,  "min_offset": 0.08, "max_offset": 0.60,  "min_tp": 25.0, "max_tp":  50.0, "base_lot": 0.01, "std_gap": 0.10, "std_offset": 0.10, "lot_mult": 1.00, "max_cycle_sl": 5.00},
    "XAUUSDc":  {"min_gap": 0.05, "max_gap": 0.80,  "min_offset": 0.08, "max_offset": 0.60,  "min_tp": 25.0, "max_tp":  50.0, "base_lot": 0.01, "std_gap": 0.10, "std_offset": 0.10, "lot_mult": 1.00, "max_cycle_sl": 5.00},
    "PAXGUSDT": {"min_gap": 0.05, "max_gap": 0.80,  "min_offset": 0.08, "max_offset": 0.60,  "min_tp": 25.0, "max_tp":  50.0, "base_lot": 0.01, "std_gap": 0.10, "std_offset": 0.10, "lot_mult": 1.00, "max_cycle_sl": 5.00},
    "GOLD":     {"min_gap": 0.05, "max_gap": 0.80,  "min_offset": 0.08, "max_offset": 0.60,  "min_tp": 25.0, "max_tp":  50.0, "base_lot": 0.01, "std_gap": 0.10, "std_offset": 0.10, "lot_mult": 1.00, "max_cycle_sl": 5.00},
...
def clamp_symbol_lot_size(symbol: str, raw_size: float) -> float:
    ...
    if any(x in clean_sym for x in ["XAU", "GOLD", "PAXG"]):
        return 0.01  # Strict flat 0.01 lot size for all Gold/PAXG contracts
    else:
        return max(0.01, min(0.05, round(raw_size, 2)))
